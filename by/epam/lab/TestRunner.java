...
public class TestRunner {
    ...
    @Before
    public void initObjects() throws FileNotFoundException, CsvLineException {
        try {
    ...
    public void testConstructor() {
        ...
        try {
            ...
            new PurchaseList("src/in.csv", Comparator.comparing(purchase -> purchase.getCost().getCoins()));
            new PurchaseList("src/in.csv", Comparator.comparing(purchase -> purchase.getCost().getRubs() * 100 + purchase.getCost().getCoins()));
        } catch (FileNotFoundException e) {
            result = false;
        }
        assertTrue(result);
    ...
    public void testWrongInsert() {
        purchases.insert(-8, new Purchase("Name", new Byn(100), 2));
    }
