...
public class FlightDao implements IFlightDao {
    private static final Logger logger = LogManager.getLogger(FlightDao.class.getName());
    ...
    public List<Flight> findAll(int limit, int offset) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                flight.setAmount(Integer.parseInt(rs.getString(ConstantsSQL.SELECT_ALL_AMOUNT_INDEX)));
                flight.setPrice(Integer.parseInt(rs.getString(ConstantsSQL.SELECT_ALL_PRICE_INDEX)));
                flights.add(flight);
            }
            return flights;
        } catch (SQLException | ConnectionException e) {
            logger.error("Unable to find all flights!");
    ...
    public Optional<Flight> findById(long id) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                flight.setAmount(Integer.parseInt(rs.getString(ConstantsSQL.SELECT_BY_ID_AMOUNT_INDEX)));
                flight.setPrice(Integer.parseInt(rs.getString(ConstantsSQL.SELECT_BY_ID_PRICE_INDEX)));
            }
            return Optional.of(flight);
        } catch (SQLException | ConnectionException e) {
            logger.error("Unable to find flight!");
            throw new DaoException(e.getMessage());
        }
    }
    ...
    public void update(Flight entity) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            logger.error("Unable to update flight!");
            throw new DaoException(e.getMessage());
        }
    }

    @Override
    public List<Flight> findByAllParameters(String from, String to, String date) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                flight.setToCity(to);
                flight.setDate(date);
                flight.setAmount(Integer.parseInt(rs.getString(ConstantsSQL.SELECT_BY_PARAM_AMOUNT_INDEX)));
                flight.setPrice(Integer.parseInt(rs.getString(ConstantsSQL.SELECT_BY_PARAM_PRICE_INDEX)));
                flights.add(flight);
            }
            return flights;
        } catch (SQLException | ConnectionException e) {
    ...
    @Override
    public List<Flight> findByParameters(String from, String to) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
