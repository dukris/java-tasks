...
public class OrderDao implements IOrderDao {
    ...
    public List<Order> findAll(int limit, int offset) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                order.setTotalCost(rs.getInt(ConstantsSQL.SELECT_ALL_TOTAL_COST_INDEX));
                orders.add(order);
            }
            return orders;
        } catch (SQLException | ConnectionException e) {
            logger.error("Unable to find all orders!");
    ...
    public Optional<Order> findById(long id) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                order.setTotalCost(rs.getInt(ConstantsSQL.SELECT_BY_ID_TOTAL_COST_INDEX));
            }
            return Optional.of(order);
        } catch (SQLException | ConnectionException e) {
            logger.error("Unable to find order!");
            throw new DaoException(e.getMessage());
        }
    }
    ...
    public void delete(long id) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            logger.error("Unable to delete order!");
            throw new DaoException(e.getMessage());
        }
    }
    ...
    public void create(Order entity) throws DaoException {
        try (Connection con = ConnectionPool.getInstance().getConnection();
            ...
            preparedStatement.setInt(ConstantsSQL.TOTAL_COST_CREATE_INDEX, entity.getTotalCost());
    ...
    public void update(Order entity) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            preparedStatement.setInt(ConstantsSQL.TOTAL_COST_UPDATE_INDEX, entity.getTotalCost());
            preparedStatement.executeUpdate();
        } catch (SQLException | ConnectionException e) {
    ...
    public List<Order> findByUserId(long userId) throws DaoException {
        try (Connection connection = ConnectionPool.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                order.setTotalCost(rs.getInt(ConstantsSQL.SELECT_BY_USER_ID_TOTAL_COST_INDEX));
                orders.add(order);
            }
            return orders;
        } catch (SQLException | ConnectionException e) {
