...
<form name="result" action="/result" onsubmit="return false">
    ...
    <a href="JavaScript:sendForm('SUM')" name="operation">sum</a>&nbsp;&nbsp;
    <a href="JavaScript:sendForm('MAX')" name="operation">max</a>&nbsp;&nbsp;
    <a href="JavaScript:sendForm('MIN')" name="operation">min</a>&nbsp;&nbsp;
    <a href="JavaScript:sendForm('AVG')" name="operation">avg</a>
